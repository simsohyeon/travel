...
public class AroundXmlParser {
    ...
    // response 태그 읽기
    private List<Around> readResponse(XmlPullParser parser) throws XmlPullParserException, IOException {
    ...
    // body 태그 읽기
    private List<Around> readBody(XmlPullParser parser) throws XmlPullParserException, IOException {
    ...
    // items 태그 읽기
    private List<Around> readItems(XmlPullParser parser) throws XmlPullParserException, IOException {
    ...
    private Around readItem(XmlPullParser parser) throws XmlPullParserException, IOException {
        ...
        return new Around(name, address, tel, latitude, longitude, distance);
    }
